...
class BaoCaoGiaThanh(models.Model):
    _name = "reportinp.bao_cao_gia_thanh.wizard"
    ...
    def print_report(self):
        data = {
            'model': 'reportinp.bao_cao_gia_thanh.wizard',
        ...
        if len(list_thanh_pham) != 0:
            ...
            print(data)
        return self.env.ref("reportinp.action_bao_cao_gia_thanh_report").report_action(self, data=data)
