# -*- coding: utf-8 -*-
{
    'name': "Stock Inventory Report Detail",
    ...
    'data': [
        ...
        'reports/reportinp_bao_cao_xuat_nhap_kho_report_template.xml',
        'reports/reportinp_bao_cao_gia_thanh_report_template.xml',
        'reports/report.xml',

        'wizard/reportinp_bao_cao_xuat_nhap_kho_wizard.xml',
        'wizard/reportinp_bao_cao_gia_thanh_wizard.xml',
